...
export default async function AdminDashboard() {
  ...
  const totalWorkflows =
    statusCounts.대기 + statusCounts.진행중 + statusCounts.완료;
    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      {stats.unreadMessages > 0 && (
        <Link href="/admin/communication">
          <Card className="bg-white border border-red-300 shadow-lg hover:shadow-xl transition-all cursor-pointer animate-pulse hover:animate-none">
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <div>
                    <p className="text-xs sm:text-sm font-semibold text-red-800 mb-0.5 sm:mb-1">
                      확인 안 한 메시지
                    </p>
          ...
          <CardContent className="p-3 sm:p-4 md:p-6">
            <div className="flex items-start justify-between mb-2 sm:mb-4">
              ...
              <div className="text-right">
                ...
                <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-navy-700">
                  {stats.totalUsers}
                </p>
              </div>
            </div>
          ...
          <CardContent className="p-3 sm:p-4 md:p-6 pt-0">
            <div className="mb-3 sm:mb-4">
              <div className="flex items-end gap-2 mb-2 sm:mb-3">
                <p className="text-3xl sm:text-4xl md:text-5xl font-bold text-navy-700">
                  {completionRate}
