...
const ALLOWED_FIELDS = [
  "브랜드명", "brandNameEnglish", "업종", "주소", "대표번호", "이메일",
  "사업자등록증URL", "프로필사진URL", "로고URL",
  "로고선호스타일", "로고선호색상", "로고선호폰트", "로고제작요청사항",
  "명함색상", "명함시안", "계약서시안",
  "홈페이지스타일", "홈페이지컬러컨셉", "홈페이지제작방식",
  "아임웹ID", "아임웹PW", "아임웹관리자PW",
  "도메인관리사이트", "도메인관리ID", "도메인관리PW",
  "은행명", "계좌번호",
  "대표자생년월일", "대표자신분증URL", "통신서비스이용증명원URL",
  "신용카드앞면URL", "로고예시디자인URL", "인쇄물받을주소",
  "메타광고관리자값", "네이버검색광고ID", "네이버검색광고PW",
  "네이버클라우드ID", "네이버클라우드PW",
  "InstagramID", "InstagramPW", "GmailID", "GmailPW",
  "해외결제카드앞면URL", "해외결제카드뒷면URL", "해외결제카드유효기간",
];
