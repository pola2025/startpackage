...
export function KanbanColumn({
  ...
  return (
    <div className="flex flex-col h-full min-h-[500px]">
      {/* 컬럼 헤더 */}
      <div className={cn(
        'rounded-t-lg p-3 border-2 border-b-0',
        color
      )}>
      ...
      <SortableContext items={items} strategy={verticalListSortingStrategy}>
        <div
          ...
          className={cn(
            ...
            isOver && 'bg-blue-50 border-blue-400 border-dashed'
          )}
        >
          {children && (
          ...
          {/* 드래그 오버 표시 */}
          {isOver && (
            <div className="mt-2 p-4 border-2 border-dashed border-blue-400 rounded-lg bg-blue-50 text-center text-sm text-blue-600">
              여기에 놓으세요
            </div>
          )}
        </div>
