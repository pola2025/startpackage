    ...
    <div className="space-y-4 md:space-y-6 max-w-7xl mx-auto px-4 md:px-0">
      ...
      <Alert className="bg-yellow-50 border-yellow-200">
        ...
        <AlertDescription className="text-yellow-800">
          <p className="font-semibold mb-1 md:mb-2 text-sm md:text-base">
            Meta 광고 시작 전 필수 확인사항
          </p>
          <ul className="space-y-1 text-xs md:text-sm">
            <li>
              • <strong>Facebook 계정 로그인 필수:</strong>{" "}
              <span className="hidden sm:inline">
                광고 결과를 직접 확인하려면
              </span>{" "}
              로그인 가능한 Facebook 계정이 있어야 합니다.
            </li>
            <li className="hidden md:block">
              • <strong>광고 관리자 접근:</strong> 광고 성과와 통계를 직접
              확인할 수 있습니다.
            </li>
          </ul>
        </AlertDescription>
          ...
          <Tabs defaultValue="case1" className="w-full">
            ...
            <div className="overflow-x-auto -mx-4 px-4 md:mx-0 md:px-0 mb-4 md:mb-6">
              <TabsList className="grid w-full min-w-[320px] grid-cols-3 h-auto p-1">
                <TabsTrigger
                  value="case1"
                  className="text-[10px] sm:text-xs md:text-sm py-2 px-1 md:px-3 flex flex-col sm:flex-row items-center gap-1"
                >
                    ...
                    <div className="space-y-3 md:space-y-4">
                      ...
                      <div className="bg-white rounded-lg p-3 md:p-4 border border-green-200">
                        ...
                        <ol className="space-y-1.5 md:space-y-2 text-xs md:text-sm text-green-800 list-decimal list-inside">
                          ...
                          <li>
                            <strong>전체 관리권한</strong> 활성화
                          </li>
                          <li>
                            <strong>고급옵션 보기</strong> 클릭
                          </li>
                          <li>
                            <strong>전체 관리권한</strong> 활성화
                          </li>
                          <li>
                            <strong>고급옵션 보기/관리</strong> 활성화
                          </li>
                          <li>
                            페이지, 광고계정, 인스타그램 →{" "}
                            <strong>모든 권한</strong>
                            <div className="ml-4 md:ml-6 mt-1 bg-yellow-50 border border-yellow-200 rounded p-2">
                              <p className="text-yellow-800 font-medium text-[10px] md:text-xs">
                                ⚠️ 스크롤로 권한 다 확인 필수
                              </p>
                            </div>
                          </li>
              ...
              <div className="bg-gold-50 border border-gold-200 rounded-lg p-4 md:p-6">
                <div className="flex items-start gap-2 md:gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-3 md:space-y-4">
                      <div>
                        <p className="text-navy-800 font-medium mb-2 text-sm md:text-base">
                          📋 제공해주실 정보
                        </p>
                      ...
                      <Alert className="bg-gold-100 border-gold-200">
                        ...
                        <AlertDescription className="text-navy-800 text-xs md:text-sm">
                          <strong>중요:</strong> PC에서 로그인이 가능해야 광고
                          설정이 가능합니다.
                        </AlertDescription>
                      </Alert>
                      <div className="bg-white rounded-lg p-3 md:p-4 border border-gold-200">
                        <p className="text-xs md:text-sm text-navy-800">
                          <strong>📌 다음 단계:</strong>
                          <br />
                          문의하기를 통해 위 정보를 전달해주시면, Facebook
                          비즈니스 계정과 광고 관리자를 설정해드립니다.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 md:p-6">
                <div className="flex items-start gap-2 md:gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-3 md:space-y-4">
                      <div>
                        <p className="text-purple-800 font-medium mb-2 text-sm md:text-base">
                          📋 준비할 정보
                        </p>
      ...
      <Card className="border-gray-200 shadow-sm">
        ...
        <CardContent className="space-y-3 md:space-y-4 p-4 md:p-6 pt-0 md:pt-0">
          <div className="bg-gold-50 border border-gold-200 rounded-lg p-3 md:p-4">
            <h4 className="font-semibold text-navy-900 mb-2 md:mb-3 text-sm md:text-base">
              📧 제출 이메일
            </h4>
            <div className="flex items-center gap-2">
              ...
              <a
                href="mailto:mkt@polarad.co.kr"
                className="text-base md:text-lg font-bold text-gold-600 underline"
              >
                mkt@polarad.co.kr
              </a>
            </div>
        ...
        <CardContent className="space-y-3 md:space-y-4 p-4 md:p-6 pt-0 md:pt-0">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
            <div className="bg-green-50 border border-green-200 rounded-lg p-3 md:p-4">
              <h4 className="font-semibold text-green-900 mb-2 md:mb-3 text-sm md:text-base">
                ✅ 저희가 관리하는 부분
              </h4>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-lg p-3 md:p-4">
              <h4 className="font-semibold text-orange-900 mb-2 md:mb-3 text-sm md:text-base">
                👤 대표님이 하실 부분
              </h4>
          ...
          <Alert className="bg-gold-50 border-gold-200">
            ...
            <AlertDescription className="text-navy-800 text-xs md:text-sm">
              <strong>광고 효율 측정 권장 일정</strong>
              <br />
              • 최소 7~10일 집행 후 성과 측정
              <br />• 3~5일간 데이터가 전혀 없으면 즉시 교체 권장
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
          ...
          <div className="space-y-2 md:space-y-3">
            <div className="bg-white border border-green-200 rounded-lg p-3 md:p-4">
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3 flex-1 min-w-0">
                  ...
                  <p className="text-xl md:text-2xl font-bold text-green-600 whitespace-nowrap">
                    무료
                  </p>
                </div>
                <Badge className="bg-green-600 text-xs whitespace-nowrap flex-shrink-0">
                  지원 서비스
                </Badge>
              </div>
            </div>
            <div className="bg-white border border-gold-200 rounded-lg p-3 md:p-4">
              <div className="flex items-center justify-between gap-3">
                ...
                <Badge className="bg-navy-900 text-xs whitespace-nowrap flex-shrink-0">
                  유료 서비스
                </Badge>
              </div>
            </div>
