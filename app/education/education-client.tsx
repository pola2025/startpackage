...
export default function EducationClient() {
  ...
  return <main className={styles.page}>
    <section className={styles.desktop}>
      <div className={styles.brand}><small>비즈액터스쿨 · 폴라애드</small><h1>온라인마케팅<br/><em>교육자료실</em></h1><p>강의 화면에 맞춘 큰 글자와 실제 화면 목업으로 Meta 설정 과정을 다시 확인합니다.</p><div className={styles.points}><span>Meta 본교육 01–07</span><span>콘텐츠 별도교육 08</span><span>업무지원 09–11</span></div></div>
