...
export default function StartPackagePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-16 md:py-24">
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
              인쇄물 디자인 + 홈페이지 제작을 한 번에<br />
              비즈니스 시작에 필요한 모든 것을 통합 진행합니다
            </p>

            {/* 핵심 강점 */}
            <div className="flex flex-wrap justify-center gap-4 mb-10">
              <div className="flex items-center gap-2 px-4 py-2 bg-[#16255e] text-white rounded-lg">
            ...
            <div className="flex justify-center">
              <a
                href="#design"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#16255e] text-white rounded-xl font-semibold hover:bg-[#1a2d6e] transition-colors"
              >
                패키지 구성 보기
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {/* 디자인 */}
            <a href="#design" className="group p-8 bg-white rounded-2xl border border-gray-200 hover:border-[#16255e] transition-all hover:shadow-lg">
              <div className="w-14 h-14 bg-[#16255e] rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <Palette className="w-7 h-7 text-white" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">인쇄물 디자인</h3>
            ...
            {/* 홈페이지 */}
            <a href="#homepage" className="group p-8 bg-white rounded-2xl border border-gray-200 hover:border-[#16255e] transition-all hover:shadow-lg">
              <div className="w-14 h-14 bg-[#16255e] rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <Globe className="w-7 h-7 text-white" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">자체개발 홈페이지</h3>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600" />
                  반응형 웹사이트
            ...
            {/* 자동화 */}
            <a href="#automation" className="group p-8 bg-white rounded-2xl border border-gray-200 hover:border-[#16255e] transition-all hover:shadow-lg">
              <div className="w-14 h-14 bg-[#16255e] rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <Zap className="w-7 h-7 text-white" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">마케팅 자동화</h3>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600" />
                  텔레그램 실시간 알림
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 mb-8 shadow-sm">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-semibold text-gray-900 mb-3">제작 방식</h4>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                    <span>기존 로고 이미지 전달 시 바로 적용</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                    <span>선호 스타일/색상/폰트 요청 시 제작</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                    <span>로고 없이도 인쇄물/홈페이지 제작 가능</span>
                  </li>
                </ul>
              </div>
              <div>
                <h4 className="font-semibold text-gray-900 mb-3">로고 유형</h4>
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1.5 bg-gray-100 rounded-lg text-sm">워드마크</span>
                  <span className="px-3 py-1.5 bg-gray-100 rounded-lg text-sm">심볼마크</span>
                  <span className="px-3 py-1.5 bg-gray-100 rounded-lg text-sm">엠블럼</span>
                  <span className="px-3 py-1.5 bg-gray-100 rounded-lg text-sm">이니셜형</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 mb-8 shadow-sm">
            ...
            <div className="mb-6">
              <p className="text-gray-600 mb-4">아르미 울트라화이트 310g / 4가지 디자인 중 선택</p>
      ...
      {/* 홈페이지 섹션 */}
      <section id="homepage" className="py-16 md:py-24 bg-slate-100">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
      ...
      {/* 자동화 서비스 섹션 */}
      <section id="automation" className="py-16 md:py-24 bg-[#16255e] text-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-white/80">
              업무 효율을 높이는 자동화 시스템을 제공합니다
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-6">
            {/* 텔레그램 알림 */}
            <div className="bg-white/10 backdrop-blur rounded-2xl p-6 md:p-8 border border-white/10">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-14 h-14 bg-blue-500 rounded-xl flex items-center justify-center">
                  <MessageSquare className="w-7 h-7 text-white" />
                </div>
                <div>
                  <h3 className="text-xl font-bold text-white">텔레그램 실시간 알림</h3>
                  <p className="text-white/70 text-sm">고객 상담 접수 즉시 알림</p>
                </div>
              </div>
              <ul className="space-y-3 text-white/90">
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-green-400 flex-shrink-0 mt-0.5" />
                  <span>홈페이지 상담 접수 시 실시간 푸시 알림</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-green-400 flex-shrink-0 mt-0.5" />
                  <span>고객 연락처, 문의 내용 즉시 확인</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-green-400 flex-shrink-0 mt-0.5" />
                  <span>모바일에서 바로 확인 가능</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur rounded-2xl p-6 md:p-8 border border-white/10">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white">SMS 자동 발송</h3>
                  <p className="text-white/70 text-sm">고객에게 자동 문자 발송</p>
                </div>
              </div>
              <ul className="space-y-3 text-white/90">
                <li className="flex items-start gap-3">
            ...
            <div className="bg-white/10 backdrop-blur rounded-2xl p-6 md:p-8 border border-white/10">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-14 h-14 bg-slate-500 rounded-xl flex items-center justify-center">
                  <BarChart3 className="w-7 h-7 text-white" />
                </div>
                <div>
                  <h3 className="text-xl font-bold text-white">메타 광고 관리</h3>
                  <p className="text-white/70 text-sm">페이스북/인스타그램 광고</p>
                </div>
              </div>
              <ul className="space-y-3 text-white/90">
                <li className="flex items-start gap-3">
            ...
            <div className="bg-white/10 backdrop-blur rounded-2xl p-6 md:p-8 border border-white/10">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white">네이버 검색 광고</h3>
                  <p className="text-white/70 text-sm">검색 광고 세팅 및 관리</p>
                </div>
              </div>
              <ul className="space-y-3 text-white/90">
                <li className="flex items-start gap-3">
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <div className="relative p-6 bg-white rounded-2xl border border-gray-200 text-center">
              <div className="w-10 h-10 bg-[#16255e] text-white rounded-full flex items-center justify-center mx-auto mb-4 font-bold">
                1
              </div>
              <h3 className="font-bold text-gray-900 mb-2">자료 제출</h3>
              <p className="text-sm text-gray-600">로고, 사진, 텍스트 등<br />필요 자료 전달</p>
            ...
            <div className="relative p-6 bg-white rounded-2xl border border-gray-200 text-center">
              ...
              <h3 className="font-bold text-gray-900 mb-2">디자인 제작</h3>
              <p className="text-sm text-gray-600">시안 제작 및<br />피드백 반영</p>
              <div className="hidden md:block absolute top-1/2 -right-2 transform -translate-y-1/2 z-10">
                <ArrowRight className="w-4 h-4 text-gray-400" />
              </div>
            </div>
            <div className="relative p-6 bg-white rounded-2xl border border-gray-200 text-center">
              ...
              <h3 className="font-bold text-gray-900 mb-2">발주</h3>
              <p className="text-sm text-gray-600">인쇄물 발주 및<br />홈페이지 세팅</p>
              <div className="hidden md:block absolute top-1/2 -right-2 transform -translate-y-1/2 z-10">
                <ArrowRight className="w-4 h-4 text-gray-400" />
              </div>
            </div>
            <div className="p-6 bg-white rounded-2xl border border-gray-200 text-center">
              ...
              <h3 className="font-bold text-gray-900 mb-2">진행 완료</h3>
              <p className="text-sm text-gray-600">인쇄물 배송 및<br />홈페이지 오픈</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Footer */}
      <footer id="contact" className="bg-[#16255e] text-white py-16">
