...
CREATE TABLE "education_access_events" (
  "id" TEXT PRIMARY KEY NOT NULL,
  "userId" TEXT,
  "cohortId" TEXT,
...
CREATE INDEX "education_access_events_createdAt_id_idx" ON "education_access_events" ("createdAt", "id");
CREATE INDEX "education_access_events_eventType_createdAt_id_idx" ON "education_access_events" ("eventType", "createdAt", "id");
CREATE INDEX "education_access_events_userId_createdAt_id_idx" ON "education_access_events" ("userId", "createdAt", "id");
CREATE INDEX "education_access_events_ipHash_createdAt_id_idx" ON "education_access_events" ("ipHash", "createdAt", "id");

CREATE TABLE "education_extension_requests" (
  "id" TEXT PRIMARY KEY NOT NULL,
  "userId" TEXT NOT NULL,
...
CREATE INDEX "education_extension_requests_status_requestedAt_id_idx" ON "education_extension_requests" ("status", "requestedAt", "id");
CREATE INDEX "education_extension_requests_userId_requestedAt_id_idx" ON "education_extension_requests" ("userId", "requestedAt", "id");

CREATE TABLE "education_ip_blocks" (
...
CREATE INDEX "education_ip_blocks_blockedUntil_idx" ON "education_ip_blocks" ("blockedUntil");

CREATE TABLE "education_rate_windows" (
...
CREATE INDEX "education_rate_windows_action_updatedAt_idx" ON "education_rate_windows" ("action", "updatedAt");
CREATE INDEX "education_rate_windows_blockedUntil_idx" ON "education_rate_windows" ("blockedUntil");
