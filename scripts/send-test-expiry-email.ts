/**
 * 서비스 만료 안내 이메일 테스트 발송 스크립트
 * 실행: npx tsx scripts/send-test-expiry-email.ts
 */
...
async function sendTestEmail() {
  ...
  console.log("   수신자: framei@naver.com");
  console.log("   제목: [테스트] 자동화서비스 만료 안내");
